...
export const timeline: TimelineEra[] = [
  {
    ...
    link: '/annals/01-dawn',
    events: [
      { year: '1943', event: '麦卡洛克与皮茨发表神经元数学模型，首次证明大脑活动可以用数学描述', link: '/annals/01-dawn' },
      { year: '1948', event: '维纳出版《控制论》，提出机器与生物共享反馈机制的洞察', link: '/biographies/wiener' },
      { year: '1949', event: '赫布提出赫布学习规则——"一起激发的神经元连接在一起"', link: '/annals/01-dawn' },
      { year: '1950', event: '图灵发表《计算机器与智能》，提出"模仿游戏"（图灵测试）', link: '/biographies/turing' },
      { year: '1951', event: '明斯基与埃德蒙兹建造 SNARC——人类历史上第一台神经网络硬件', link: '/biographies/minsky' },
      { year: '1952', event: '塞缪尔在 IBM 开发跳棋程序，开创机器学习的先河', link: '/houses/ibm-research' },
      { year: '1955', event: '纽厄尔与西蒙创建 Logic Theorist，首个能自动证明数学定理的 AI 程序', link: '/biographies/herbert-simon' },
      { year: '1956', event: 'Dartmouth 会议召开，麦卡锡正式命名"人工智能"，AI 作为学科诞生', link: '/annals/01-dawn' },
    ],
  },
  {
    name: '黄金时代',
    ...
    events: [
      { year: '1958', event: '麦卡锡发明 LISP 语言，成为 AI 研究的标准工具；罗森布拉特发明感知机，引发全球轰动', link: '/biographies/mccarthy' },
      { year: '1965', event: '费根鲍姆在斯坦福开发 DENDRAL，首个成功的专家系统', link: '/annals/02-golden-age' },
      { year: '1966', event: '维森鲍姆创建 ELIZA 聊天程序，用户竟然对一个程序产生了感情', link: '/annals/02-golden-age' },
      { year: '1969', event: '明斯基与派珀特出版《感知机》，数学证明单层网络的局限性，神经网络陷入寒冬', link: '/treatises/neural-networks' },
    ],
  },
  {
    name: '第一次寒冬',
  ...
  },
  {
    ...
    events: [
      ...
      { year: '1986', event: '鲁梅尔哈特、辛顿、威廉姆斯在《自然》上发表反向传播算法，多层神经网络终于可以训练', link: '/biographies/hinton' },
    ],
  },
  {
    name: '第二次寒冬',
  ...
  },
  {
    ...
    events: [
      { year: '1997', event: 'IBM Deep Blue 击败国际象棋世界冠军卡斯帕罗夫，全球震动，登上各大报纸头版', link: '/treatises/ai-games' },
      { year: '2006', event: '辛顿提出深度信念网络，证明深层神经网络可以有效训练，深度学习复兴的号角', link: '/biographies/hinton' },
      { year: '2009', event: '李飞飞团队发布 ImageNet 数据集，1400 万张手工标注图片，为深度学习革命埋下种子', link: '/biographies/fei-fei-li' },
  ...
  },
  {
    ...
    events: [
      ...
      { year: '2014', event: '古德费洛在蒙特利尔一个酒吧的灵感中发明生成对抗网络（GAN），开创生成式 AI', link: '/houses/mila' },
      { year: '2015', event: 'ResNet 突破 100 层深度网络；Google 开源 TensorFlow，深度学习工具民主化', link: '/treatises/ai-open-source' },
      { year: '2016', event: 'AlphaGo 以 4:1 击败围棋世界冠军李世石，AI 攻克人类最复杂的棋类游戏', link: '/houses/deepmind' },
    ],
  },
  {
    name: 'Transformer 纪元',
  ...
  },
  {
    ...
    events: [
      { year: '2023', event: 'GPT-4 发布，多模态能力震撼业界；Meta 开源 LLaMA 引爆开源大模型运动；辛顿离开 Google 公开警告 AI 风险', link: '/treatises/ai-open-source' },
      { year: '2024', event: 'OpenAI 发布 Sora 视频生成模型；Anthropic 发布 Claude 3；辛顿获诺贝尔物理学奖，哈萨比斯获诺贝尔化学奖——AI 研究者首次获诺奖', link: '/treatises/ai-art' },
