...
1955 年夏天，正在为 IBM 设计 701 大型机的<Person id="rochester" />，与<Person id="mccarthy" />、<Person id="minsky" />、<Person id="shannon" /> 联名签署了那份著名的提案——《关于举办达特茅斯人工智能夏季研究计划的建议》。罗切斯特是 IBM 一方的代表，也是四位发起人中唯一来自工业界的人。

1956 年的达特茅斯会议把"Artificial Intelligence"这个词钉进历史，IBM 是产业界唯一的在场者。这个起跑线，IBM 此后用了七十年也没让出过。

也是在那个夏天前后，IBM Poughkeepsie 实验室的<Person id="samuel" /> 在 IBM 701 上写出了第一个能从经验中学习的跳棋程序。塞缪尔让程序与自己对弈，记录每一步的胜负权重，逐步调整评估函数。
...
1972 年，捷克裔工程师<Person id="jelinek" /> 从康奈尔大学转入 IBM 沃森研究中心，接掌语音识别与自然语言研究组。彼时主流学界仍信奉乔姆斯基的生成语法，相信语言要靠规则。耶利内克偏不——他坚持用隐马尔可夫模型（HMM）和统计方法处理语音，让数据说话。
...
1996 年 2 月，费城。Deep Blue 第一局击败了卫冕世界冠军<Person id="kasparov" />，但卡斯帕罗夫稳住阵脚，最终以 4 比 2 取胜。一年后的复赛改写了历史。
