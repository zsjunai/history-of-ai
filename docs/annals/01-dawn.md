...
> 一个离家出走的少年在图书馆里读到了罗素的《数学原理》，然后给罗素写了一封信，指出书中的错误。几年后，这个少年与一位神经科学家合写了一篇论文，证明大脑可以被翻译成数学。再过十三年，一群数学家、工程师和心理学家聚集在新罕布什尔州的一所常春藤学院里，给他们共同追寻的事业取了一个名字——人工智能。这十三年，是一切的开端。
...
阿兰·图灵（Alan Turing）早在 1936 年就用他著名的图灵机（Turing Machine）模型证明了一件意义深远的事：存在一种通用机器，它可以模拟任何其他机器的计算过程。这个纯粹数学的结论，在当时看起来只是逻辑学的内部事务。但图灵本人对此有更大的野心。
...
图灵并非孤军作战。阿隆佐·邱奇（Alonzo Church）几乎在同一时期独立发展出了 lambda 演算（Lambda Calculus），从另一条路径刻画了"可计算性"的边界。邱奇-图灵论题（Church-Turing Thesis）断言：任何在直觉上可以被"有效计算"的东西，都可以被图灵机（或等价地，被 lambda 演算）计算。这个论题至今无法被严格证明，但也从未被推翻。它悄悄地为人工智能提供了一个哲学地基——如果思维是某种信息处理过程，而所有信息处理过程都可以被图灵机模拟，那么从原则上说，机器就可以思考。

## 三、神经科学家：大脑是一台计算机

### 流浪少年与神经元模型

关于沃尔特·皮茨（Walter Pitts）的故事，怎么讲述都不为过。

1923 年出生于底特律一个贫困家庭的皮茨，童年饱受父亲虐待和街头霸凌之苦。十几岁时，他逃离了家庭，在芝加哥大学的图书馆里栖身度日。他没有正式入学，但他在那些书架之间自学了数理逻辑、拉丁语和希腊语。十五岁那年，他读到了伯特兰·罗素（Bertrand Russell）与怀特海（Alfred North Whitehead）合著的《数学原理》（*Principia Mathematica*），发现了其中的逻辑漏洞，写信给罗素指出。罗素大为赞赏，邀请他去剑桥——但战争阻断了这条路。

皮茨留在了芝加哥，在那里遇到了改变他命运的人——神经生理学家沃伦·麦卡洛克（Warren McCulloch）。麦卡洛克比皮茨年长二十五岁，是一位兼具诗人气质和科学家严谨的奇人，痴迷于一个问题：大脑如何产生思想？

1943 年，这对忘年之交发表了论文《神经活动中内在观念的逻辑演算》（A Logical Calculus of the Ideas Immanent in Nervous Activity）。皮茨当时只有十八岁，是一个没有任何学术背景的流浪少年。但这篇论文的深度和原创性令人惊叹。
...
1949 年，加拿大心理学家唐纳德·赫布（Donald Hebb）在《行为的组织》（*The Organization of Behavior*）中给出了一个优美的回答。他提出了一条学习原则：当两个神经元反复同时激活时，它们之间的突触连接会被加强。后世将这条规则浓缩为一句口号——"一起激活的神经元会连接在一起"（Neurons that fire together wire together）。
...
诺伯特·维纳（Norbert Wiener）是最早回答这个问题的人之一。二战期间，维纳研究防空火控系统——自动瞄准的高射炮如何追踪飞速移动的敌机？他意识到，这个工程问题的核心与生物学中的运动控制惊人地相似：两者都依赖"反馈"（Feedback）——系统不断将实际输出与期望目标进行比较，然后修正偏差。
...
如果说图灵定义了"什么是可计算的"，那么约翰·冯·诺伊曼（John von Neumann）定义了"如何去计算"。冯·诺伊曼在 1945 年起草的 EDVAC 报告确立了存储程序计算机（Stored-program Computer）的体系结构——程序和数据存储在同一块内存中，可以被灵活地读取和修改。这一架构延续至今，几乎所有现代计算机都是"冯·诺伊曼机器"。
...
1951 年，年仅二十四岁的普林斯顿研究生马文·明斯基（Marvin Minsky）和同学迪恩·埃德蒙兹（Dean Edmonds）做了一件看似疯狂的事：他们用三千根真空管和一堆战争剩余的零件，拼凑出了世界上第一台硬件神经网络计算机——SNARC（Stochastic Neural Analog Reinforcement Calculator）。
...
1952 年，IBM 工程师阿瑟·塞缪尔（Arthur Samuel）开发了一个下西洋跳棋（Checkers）的程序。这个程序的革命性之处不在于它会下棋——下棋程序此前已有先例——而在于它会自己变强。塞缪尔没有试图穷举所有棋路，而是让程序通过与自己对弈来积累经验，不断调整自己的局面评估函数。
...
约翰·麦卡锡（John McCarthy）决定改变这一点。这位在达特茅斯学院（Dartmouth College）任教的年轻数学家，说服了马文·明斯基、IBM 的纳撒尼尔·罗切斯特（Nathaniel Rochester）和信息论之父克劳德·香农（Claude Shannon），四人联名向洛克菲勒基金会（Rockefeller Foundation）提交了一份提案，申请资助一场为期两个月的暑期研讨会。
...
艾伦·纽厄尔（Allen Newell）和赫伯特·西蒙（Herbert Simon）带来了他们与程序员克利夫·肖（Cliff Shaw）合作开发的"逻辑理论家"（Logic Theorist）。这个程序能够自动证明怀特海和罗素《数学原理》中的数学定理——它成功证明了第二章 52 条定理中的 38 条，其中一些证明甚至比原著中的更为简洁优雅。
...
| 年份 | 事件 | 关键人物 |
|------|------|---------|
| 1936 | 图灵机模型；lambda 演算 | Turing, Church |
| 1943 | 神经元逻辑模型 | McCulloch, Pitts |
| 1946—53 | 梅西控制论会议 | Wiener 等 |
| 1948 | 《控制论》出版；信息论奠基 | Wiener, Shannon |
| 1949 | 赫布学习规则 | Hebb |
| 1950 | 图灵测试 | Turing |
| 1951 | SNARC 神经网络计算机 | Minsky, Edmonds |
| 1952 | 跳棋学习程序 | Samuel |
| 1955 | 逻辑理论家；达特茅斯提案 | Newell, Simon, McCarthy |
| 1956 | 达特茅斯会议，"人工智能"命名 | McCarthy, Minsky, Shannon, Rochester |
...
::: info 征集中
如果你了解这段历史的第一手资料或亲历者回忆，欢迎[提交贡献](https://github.com/T-7788/history-of-ai)。
:::
