...
1973 年，英国广播公司（BBC）组织了一场围绕莱特希尔报告的电视辩论。莱特希尔在一边，另一边是英国 AI 研究的代表人物——爱丁堡大学的唐纳德·米奇（Donald Michie）和理查德·格雷戈里（Richard Gregory），以及远道而来的麦卡锡。

辩论的气氛充满火药味。米奇和麦卡锡激烈反驳莱特希尔的结论，认为他对 AI 的理解过于肤浅，用静态的标准评判一个快速发展的领域。但莱特希尔不为所动——他要求看到的是"成果"，而不是"前景"。

辩论没有赢家，但后果是清晰的。英国科学研究委员会接受了莱特希尔报告的基本判断，大幅削减了 AI 研究的资助。除爱丁堡大学（Edinburgh University）在米奇的坚持下保留了一定规模的研究外，英国的 AI 研究几乎全面萎缩。伦敦大学、萨塞克斯大学等机构的 AI 项目被关闭或并入其他系科。
...
与此同时，ALPAC 报告（1966）的余波继续发酵。机器翻译研究在美国几乎完全停止，直到 1980 年代才逐渐恢复。
...
以一个简单的例子说明：如何让计算机理解"约翰走进了餐厅，服务员给了他一份菜单"这句话？人类读者会自动推断约翰是顾客、服务员在餐厅工作、菜单是用来点菜的。但这些"显而易见"的推断依赖于大量的背景知识——关于餐厅的运作方式、社会角色、商业交易。明斯基在 1974 年提出了"框架"（Frame）理论，试图用结构化的知识单元来捕捉这种背景知识。罗杰·尚克（Roger Schank）则提出了"脚本"（Script）理论，用预设的事件序列来表示常识性的场景知识。

这些理论在小规模演示中运行良好，但它们都面临同一个问题：常识知识的规模是无底洞。你可以编写一个"餐厅脚本"，但你还需要"医院脚本""超市脚本""葬礼脚本"——以及无数脚本之间的交叉关联。知识工程的工作量呈指数级增长，而且永远不可能"完成"。

### 框架问题

哲学家约翰·麦卡锡和帕特里克·海斯（Patrick Hayes）在 1969 年提出了"框架问题"（Frame Problem）——一个看似简单却极其深刻的难题：当一个动作发生时，系统如何知道哪些事情改变了，哪些没有改变？
...
在欧洲，法国马赛大学的阿兰·科尔梅劳尔（Alain Colmerauer）和英国爱丁堡大学的罗伯特·科瓦尔斯基（Robert Kowalski）在 1972 年合作开发了 Prolog（Programming in Logic）语言。Prolog 将逻辑推理直接嵌入编程语言本身——程序员只需声明事实和规则，系统自动进行推理。
...
**第四，寒冬不是死亡。** 尽管资助大幅削减、公众热情消退，AI 研究从未完全停止。专家系统在实验室中悄悄成熟，Prolog 在欧洲生根发芽，知识表示理论在困境中深化。当 1980 年日本宣布启动第五代计算机计划时，一场新的繁荣已经蓄势待发。
...
| 1972 | Prolog 语言诞生 | 科尔梅劳尔（Alain Colmerauer）、科瓦尔斯基（Robert Kowalski） |
| 1973 | 莱特希尔报告发表，英国大幅削减 AI 资助 | <Person id="lighthill" /> |
| 1973 | BBC 组织莱特希尔报告电视辩论 | <Person id="lighthill" />、米奇（Donald Michie）、<Person id="mccarthy" /> |
