...
乔丹还培养了一批改变 AI 格局的学生——<Person id="ng" />后来成为深度学习的布道者和在线教育的先驱；<Person id="bengio" />曾在乔丹组做博士后研究。
...
**第四，杨立昆的 CNN 在等待它的时代。** <Person id="lecun" />在 1998 年发表了 LeNet-5——一个用卷积神经网络识别手写数字的系统，在银行支票识别等应用中表现出色。但在 SVM 统治的年代，CNN 没有获得广泛关注。杨立昆后来回忆说，2000 年代是神经网络研究最"孤独"的时期——论文投不出去，资助拿不到，会议上的听众寥寥无几。但他、<Person id="hinton" />和本吉奥坚持了下来。他们的坚持将在下一个时代得到回报。
